            ...
            <div class="card-header card-header-tabs card-header-primary">
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <span class="nav-tabs-title">VICEPRESIDENCIA RECURSOS HUMANOS</span>
    </div></div></div></div></div>
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-warning card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($vacacionesDDVPRH,0) }}
              <input type="hidden" id="vacaciones" name="vacaciones" value={{ $vacacionesVPRH }} />
            ...
            <div class="card-footer" style="align:center">
             <!-- <p class="stats"><span class="text-success"> Aplicados : </span>  {{ number_format($vacacionesVPRHA,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Denegados : </span>  {{ number_format($vacacionesVPRHD,0) }}</p></br>-->
              <p class="stats"><span class="text-success"> Eventualidades : </span>  {{ number_format($vacacionesEvenVPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Periodos : </span>  {{ number_format($vacacionesPerVPRH,0) }}</p></br>
            </div>   
            <div class="card-footer" style="align:center">
             <!-- <p class="stats"><span class="text-success"> Cancelados  :</span>  {{ number_format($vacacionesVPRHC,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Pendientes  : </span>  {{ number_format($vacacionesVPRHP,0) }}</p></br>-->
              <p class="stats"><span class="text-success"> Excepciones  :</span>  {{ number_format($vacacionesExcVPRH,0) }}</p></br>
            ...
            <div class="card-footer">
              <div class="stats">
                ...
                <a href="{{ route('excepcionesVPRH') }}">Detalle Excepciones...</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($permisosVPRH,0) }}</h3>
              <input type="hidden" id="permisos" name="permisos" value={{ $permisosVPRH }} />
            </div>
            <div class="card-footer" style="align:center">
             <p class="stats"><span class="text-success"> Dias C/S : </span>  {{ number_format($permisosDCSVPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success">Dias S/S : </span>  {{ number_format($permisosDSSVPRH,0) }}</p></br>
              
           <!--   <p class="stats"><span class="text-success"> Aplicados : </span>  {{ number_format($permisosVPRHA,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Denegados : </span>  {{ number_format($permisosVPRHD,0) }}</p></br>-->
            </div>   
            <div class="card-footer" style="align:center">
            <p class="stats"><span class="text-success"> Horas C/S  :</span>  {{ number_format($permisosHCSVPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Horas S/S  : </span>  {{ number_format($permisosHSSVPRH,0) }}</p></br>
            <!--  <p class="stats"><span class="text-success"> Cancelados  :</span>  {{ number_format($permisosVPRHC,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Pendientes  : </span>  {{ number_format($permisosVPRHP,0) }}</p></br>-->
            </div>
          <!--  <div class="card-footer">
              <div class="stats">
                <i class="material-icons">date_range</i> 
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($faltasjustificadasVPRH,0) }}</h3>
              <input type="hidden" id="faltas_justificadas" name="faltas_justificadas" value={{ $faltasjustificadasVPRH }} />
            </div>
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Enfermedad Trabajador : </span>  {{ number_format($faltasM1VPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success">Legal : </span>  {{ number_format($faltasM3VPRH,0) }}</p></br>
            </div>   
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Enfermedad Familiar  :</span>  {{ number_format($faltasM2VPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Escolar : </span>  {{ number_format($faltasM4VPRH,0) }}</p></br>
            </div>
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Familiar Internado  :</span>  {{ number_format($faltasM6VPRH,0) }}</p></br>
              <p class="stats">
            </div>  
           <!-- <div class="card-footer">
              <div class="stats">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($incapacidadesDDVPRH,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $incapacidadesVPRH }} />
            </div>
           <!-- <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Inicial : </span>  {{ number_format($incapacidadesIVPRH,0) }}</p></br>
              <p class="stats"> <span class="text-success">Subsecuente : </span>  {{ number_format($incapacidadesSVPRH,0) }}</p></br>
            </div>-->  
            <!--<div class="card-footer">
              <div class="stats">
                <i class="material-icons">date_range</i> 
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-secondary card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($retardosVPRH,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $retardosVPRH }} />
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($faltasinjustificadasVPRH,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $faltasinjustificadasVPRH }} />
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-info">
              <h4 class="card-title">Reporte Vicepresidencia Recursos Humanos</h4>
            ...
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tr>
                    ...
                    @endphp
                    @foreach($perVPRH as $per)
                        
                          @if($dep->des_edo_neg == $per->des_edo_neg)
                            @php
                              $totalper = $totalper + $per->perVPRH;
                            @endphp
                            <td align='center'>{!! $per->perVPRH !!}</td>
                    ...
                    @forelse($departamentoV as $depV)
                      @if($depV->des_edo_neg == $dep->des_edo_neg)
                        ...
                        <td align='center'>{{ $depV->vacdias }}</br><font color=blue size=2.0px>{{ ' ('.number_format(($depV->vacdias)/$per->perVPRH,1).' d/p)' }}</font></td>
                        @php
                          $valor2=1;
                        @endphp
                      @endif
                    ...
                    @forelse($departamentoP as $depP)
                      @if($depP->des_edo_neg == $dep->des_edo_neg)
                        ...
                        @endphp
                        @if ($permisosVPRH != 0 )
                        <td align='center'>{!! $depP->per !!}</br><font color=blue size=2.5px>{{ '('.number_format(($depP->per*100)/$permisosVPRH,2).'%)' }}</font></td>
                        @else
                   ...
                   @forelse($departamentoI as $depI)
                      @if($depI->des_edo_neg == $dep->des_edo_neg)
                        ...
                        <td align='center'>{{ $depI->incdias }}</br><font color=blue size=2.0px>{{ ' ('.number_format(($depI->incdias)/$per->perVPRH,1).' d/p)' }}</font></td>
                        @php
                          $valor1=1;
                        @endphp
                      @else
                ...
                @endforeach 
                  <tr>
                    ...
                    <td align='center'><b>{{ number_format($vacacionesVPRH,0) }}</b></td>
                    @if($totalper != 0)
                    ...
                    @endif
                    @if($permisosVPRH != 0)
                    <td align='center'><b>{{ number_format($permisosVPRH,0) }}</br><font color=blue size=2.5px>{{ '('.number_format(($permisosVPRH*100)/$permisosVPRH,2).'%)' }}</font></b></td>
                    @else
                    <td align='center'><b>{{ number_format($permisosVPRH,0) }}</br><font color=blue size=2.5px>{{ '('.number_format(0,2).'%)' }}</font></b></td>
                    @endif
                    <td align='center'><b>{{ number_format($total_diasp,0) }}</b></td>
                    <td align='center'><b>{{ number_format($faltasjustificadasVPRH,0) }}</b></td>
                    <td align='center'><b>{{ number_format($incapacidadesVPRH,0) }}</b></td>
                    @if($totalper != 0)
                    ...
                    @endif
                    <td align='center'><b>{{ number_format($retardosVPRH,0) }}</b></td>
                    <td align='center'><b>{{ number_format($faltasinjustificadasVPRH,0) }}</b></td>
                  </tr>
...
<script>
  ...
  $('#fecha_final').change(function () {
    window.location.href="fechasVPRH?inicial="+$('#fecha_inicial').val()+"&final="+$('#fecha_final').val();
