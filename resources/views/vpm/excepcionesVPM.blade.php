            ...
            <div class="card-header card-header-tabs card-header-primary">
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <span class="nav-tabs-title">Excepciones Manufactura</span>
    </div></div></div></div></div>
...
<script>
  ...
  $('#fecha_final').change(function () {
    window.location.href="fechas_excepVPM?inicial="+$('#fecha_inicial').val()+"&final="+$('#fecha_final').val();
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-info">
              <h4 class="card-title">Excepciones Vacaciones Manufactura </h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tbody>                   
                    @php
                        $vac=0;
                    @endphp                          
                    @foreach($detallevacVPM as $detalle)
                        @if($vac%2==0)   
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-success">
              <h4 class="card-title">Excepciones Permisos Manufactura </h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tbody>                   
                    @php
                        $per=0;
                    @endphp                          
                    @foreach($detalleperVPM as $detalle)
                        @if($per%2==0)   
