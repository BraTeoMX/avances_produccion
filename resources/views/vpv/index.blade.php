@extends('layouts.app', ['activePage' => 'avanceproduccion', 'titlePage' => __('Vicepresidencia Ventas')])
            ...
            <div class="card-header card-header-tabs card-header-primary">
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <span class="nav-tabs-title">VICEPRESIDENCIA VENTAS</span>
    </div></div></div></div></div>
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-warning card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($vacacionesDDVPV,0) }}
              <input type="hidden" id="vacaciones" name="vacaciones" value={{ $vacacionesVPV }} />
            ...
            <div class="card-footer" style="align:center">
             <!-- <p class="stats"><span class="text-success"> Aplicados : </span>  {{ number_format($vacacionesVPVA,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Denegados : </span>  {{ number_format($vacacionesVPVD,0) }}</p></br>-->
              <p class="stats"><span class="text-success"> Eventualidades : </span>  {{ number_format($vacacionesEvenVPV,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Periodos : </span>  {{ number_format($vacacionesPerVPV,0) }}</p></br>
            </div>   
            <div class="card-footer" style="align:center">
             <!-- <p class="stats"><span class="text-success"> Cancelados  :</span>  {{ number_format($vacacionesVPVC,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Pendientes  : </span>  {{ number_format($vacacionesVPVP,0) }}</p></br>-->
              <p class="stats"><span class="text-success"> Excepciones  :</span>  {{ number_format($vacacionesExcVPV,0) }}</p></br>
            ...
            <div class="card-footer">
              <div class="stats">
                ...
                <a href="{{ route('excepcionesVPV') }}">Detalle Excepciones...</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($permisosVPV,0) }}</h3>
              <input type="hidden" id="permisos" name="permisos" value={{ $permisosVPV }} />
            </div>
            <div class="card-footer" style="align:center">
             <p class="stats"><span class="text-success"> Dias C/S : </span>  {{ number_format($permisosDCSVPV,0) }}</p></br>
              <p class="stats"> <span class="text-success">Dias S/S : </span>  {{ number_format($permisosDSSVPV,0) }}</p></br>
              
           <!--   <p class="stats"><span class="text-success"> Aplicados : </span>  {{ number_format($permisosVPVA,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Denegados : </span>  {{ number_format($permisosVPVD,0) }}</p></br>-->
            </div>   
            <div class="card-footer" style="align:center">
            <p class="stats"><span class="text-success"> Horas C/S  :</span>  {{ number_format($permisosHCSVPV,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Horas S/S  : </span>  {{ number_format($permisosHSSVPV,0) }}</p></br>
            <!--  <p class="stats"><span class="text-success"> Cancelados  :</span>  {{ number_format($permisosVPVC,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Pendientes  : </span>  {{ number_format($permisosVPVP,0) }}</p></br>-->
            </div>
          <!--  <div class="card-footer">
              <div class="stats">
                <i class="material-icons">date_range</i> 
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($faltasjustificadasVPV,0) }}</h3>
              <input type="hidden" id="faltas_justificadas" name="faltas_justificadas" value={{ $faltasjustificadasVPV }} />
            </div>
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Enfermedad Trabajador : </span>  {{ number_format($faltasM1VPV,0) }}</p></br>
              <p class="stats"> <span class="text-success">Legal : </span>  {{ number_format($faltasM3VPV,0) }}</p></br>
            </div>   
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Enfermedad Familiar  :</span>  {{ number_format($faltasM2VPV,0) }}</p></br>
              <p class="stats"> <span class="text-success"> Escolar : </span>  {{ number_format($faltasM4VPV,0) }}</p></br>
            </div>
            <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Familiar Internado  :</span>  {{ number_format($faltasM6VPV,0) }}</p></br>
              <p class="stats">
            </div>  
           <!-- <div class="card-footer">
              <div class="stats">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($incapacidadesDDVPV,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $incapacidadesVPV }} />
            </div>
           <!-- <div class="card-footer" style="align:center">
              <p class="stats"><span class="text-success"> Inicial : </span>  {{ number_format($incapacidadesIVPV,0) }}</p></br>
              <p class="stats"> <span class="text-success">Subsecuente : </span>  {{ number_format($incapacidadesSVPV,0) }}</p></br>
            </div>-->  
            <!--<div class="card-footer">
              <div class="stats">
                <i class="material-icons">date_range</i> 
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-secondary card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($retardosVPV,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $retardosVPV }} />
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="card-title">{{ number_format($faltasinjustificadasVPV,0) }}</h3>
              <input type="hidden" id="incapacidades" name="vacaciones" value={{ $faltasinjustificadasVPV }} />
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-info">
              <h4 class="card-title">Reporte Vicepresidencia Ventas</h4>
            ...
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tr>
                    ...
                    @endphp
                    @foreach($perVPV as $per)
                        
                          @if($dep->des_edo_neg == $per->des_edo_neg)
                            @php
                              $totalper = $totalper + $per->perVPV;
                            @endphp
                            <td align='center'>{!! $per->perVPV !!}</td>
                    ...
                    @forelse($departamentoV as $depV)
                      @if($depV->des_edo_neg == $dep->des_edo_neg)
                        ...
                        <td align='center'>{{ $depV->vacdias }}</br><font color=blue size=2.0px>{{ ' ('.number_format(($depV->vacdias)/$per->perVPV,1).' d/p)' }}</font></td>
                        @php
                          $valor2=1;
                        @endphp
                      @endif
                    ...
                    @forelse($departamentoP as $depP)
                      @if($depP->des_edo_neg == $dep->des_edo_neg)
                        ...
                        @endphp
                        @if ($permisosVPV != 0 )
                        <td align='center'>{!! $depP->per !!}</br><font color=blue size=2.5px>{{ '('.number_format(($depP->per*100)/$permisosVPV,2).'%)' }}</font></td>
                        @else
                   ...
                   @forelse($departamentoI as $depI)
                      @if($depI->des_edo_neg == $dep->des_edo_neg)
                        ...
                        <td align='center'>{{ $depI->incdias }}</br><font color=blue size=2.0px>{{ ' ('.number_format(($depI->incdias)/$per->perVPV,1).' d/p)' }}</font></td>
                        @php
                          $valor1=1;
                        @endphp
                      @else
                ...
                @endforeach 
                  <tr>
                    ...
                    <td align='center'><b>{{ number_format($vacacionesVPV,0) }}</b></td>
                    @if($totalper != 0)
                    ...
                    @endif
                    @if($permisosVPV != 0)
                    <td align='center'><b>{{ number_format($permisosVPV,0) }}</br><font color=blue size=2.5px>{{ '('.number_format(($permisosVPV*100)/$permisosVPV,2).'%)' }}</font></b></td>
                    @else
                    <td align='center'><b>{{ number_format($permisosVPV,0) }}</br><font color=blue size=2.5px>{{ '('.number_format(0,2).'%)' }}</font></b></td>
                    @endif
                    <td align='center'><b>{{ number_format($total_diasp,0) }}</b></td>
                    <td align='center'><b>{{ number_format($faltasjustificadasVPV,0) }}</b></td>
                    <td align='center'><b>{{ number_format($incapacidadesVPV,0) }}</b></td>
                    @if($totalper != 0)
                    ...
                    @endif
                    <td align='center'><b>{{ number_format($retardosVPV,0) }}</b></td>
                    <td align='center'><b>{{ number_format($faltasinjustificadasVPV,0) }}</b></td>
                  </tr>
...
<script>
  ...
  $('#fecha_final').change(function () {
    window.location.href="fechasVPV?inicial="+$('#fecha_inicial').val()+"&final="+$('#fecha_final').val();
