            ...
            <div class="card-header card-header-tabs card-header-primary">
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <span class="nav-tabs-title">Excepciones Finanzas</span>
    </div></div></div></div></div>
...
<script>
  ...
  $('#fecha_final').change(function () {
    window.location.href="fechas_excepVPF?inicial="+$('#fecha_inicial').val()+"&final="+$('#fecha_final').val();
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-info">
              <h4 class="card-title">Excepciones Vacaciones Finanzas </h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tbody>                   
                    @php
                        $vac=0;
                    @endphp                          
                    @foreach($detallevacVPF as $detalle)
                        @if($vac%2==0)   
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header card-header-success">
              <h4 class="card-title">Excepciones Permisos Finanzas </h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body table-responsive">
              <table class="table table-hover">
                ...
                <tbody>                   
                    @php
                        $per=0;
                    @endphp                          
                    @foreach($detalleperVPF as $detalle)
                        @if($per%2==0)   
